...
<template>
  <UApp>
    ...
    <!-- Top Menu -->
    <nav
      class="fixed top-10 left-0 right-0 z-30 h-12 px-3 bg-[#2A2A2A] text-white text-sm uppercase font-semibold border-b border-orange-500 flex items-center gap-4"
    >
      <!-- Logo (desktop only) -->
      <img
      ...
      >
        <NuxtLink
          ...
          exact-active-class="bg-[#DB7C2E] text-white "
        >
          {{ menu.label }}
          <span
            v-if="menu.promo"
