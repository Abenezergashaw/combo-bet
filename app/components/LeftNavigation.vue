  ...
  <Teleport to="body">
    ...
    <transition name="slide">
      ...
      >
        <!-- Header -->
        <div
          class="h-10 bg-[#2A2A2A] text-white px-4 flex items-center justify-between border-b"
        >
        ...
        <div class="flex-1 overflow-y-auto p-1">
          <div
            class="h-10 bg-[#2A2A2A] text-white px-4 flex items-center justify-between border-b uppercase"
          >
